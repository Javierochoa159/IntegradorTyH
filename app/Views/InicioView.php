...
<body class="dark">
    ...
    <div class="col-3 pe-3 d-flex justify-content-end">
            ...
            <a href="<?= base_url()."public/index.php/inicio/logout"?>" class="dark">Salir</a>
        </div>
    </header>
    <section class="col-12 d-flex">
        <aside class="d-flex flex-column justify-content-start">
            ...
            <div class="col-12 mb-3 dark bg-azulitoNo rounded-end-pill d-flex justify-content-start align-items-center">
                <div class="col-1"></div>
        ...
        <div class="principalDiv">
            <div class="crearTarea d-flex align-items-center justify-content-between">
                ...
                <div id="grid_list" class="btn btn-primary"><img src="https://img.icons8.com/?size=100&id=69736&format=png&color=000000" alt="grid" onclick="grid_list(event)"></div>
                    ...
                    <div class="modal-body">
                        <form id="newTarea" action="<?= base_url()."public/index.php/inicio/newtarea"?>" method="post">
                            ...
                            <div class="mb-3 d-flex justify-content-around">
                                ...
                                <?php $colores=["#6f3c1ed6","#782069d6","#401664d6","#280555d6","#276d34d6","#035f78d6"]?>
                                <div class="col-5 d-flex">
            ...
            <div id="tareasDiv" class="grid">
                <?php if(isset($tareas)){
                        foreach($tareas as $tarea){?>
                        <div class="tarea prioriTarea_<?= $tarea["prioridadTarea"] ?>" style="background-color:<?= $tarea["colorTarea"]?>;">
                            <a class="text-reset text-decoration-none" href="<?= base_url()."public/inicio/tarea"?>">
                                <div class="tituloTarea py-2 px-2"><h3 class="dark m-0"><?= $tarea["tituloTarea"] ?></h3></div>
                                <div class="fechaEstadoTarea">
                                    <div class="d-flex">
                                        <p class="dark frt"><?php if($tarea["fechaRecordatorioTarea"]!=null) echo substr($tarea["fechaRecordatorioTarea"],0,-3)?></p>
                                        <p class="dark fvt"><?= substr($tarea["fechaVencimientoTarea"],0,-3)?></p>
                                    </div>
                                    <p class="dark et"><?php 
...
<script>
    window.addEventListener("load",()=>{
        var mensaje=<?= json_encode(array_values(validation_errors()))?>;
        if(mensaje.length>0){
